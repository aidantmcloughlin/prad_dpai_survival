...
## Patch Graph Creation:
graph_script="$PROJ_ROOT/modules/preprocessing/embeddings/patchGCN/create_gcn_graph_data.py"
python $graph_script --patch_size $PATCH_SIZE --encoder $EXTRACTOR
